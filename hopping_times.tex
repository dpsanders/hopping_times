...
analytical and numerical calculations. All numerical code, in the Julia language \cite{Julia}, is available online \cite{repo}.
...
that proves useful. In Fig.~\ref{CasosIntegra} we present the three regimes as
